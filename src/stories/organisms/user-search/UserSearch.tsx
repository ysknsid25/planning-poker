    ...
    <div className="storybook-user-search">
      <div className="storybook-user-search__selected-list">
        {selectedUsers.map((user) => (
          <div key={user.id} className="storybook-user-search__selected-item">
            <Icon size="small" src={user.avatarSrc} alt={user.name} />
            <span className="storybook-user-search__user-name">{user.name}</span>
            <button
      ...
      {showResults && (
        <div className="storybook-user-search__results">
          {isLoading ? (
            <div className="storybook-user-search__loading">Loading...</div>
          ) : results.length > 0 ? (
            results.map((user) => (
              <div
                key={user.id}
            ...
            <div className="storybook-user-search__loading">No users found</div>
          )}
        </div>
      )}
    </div>
